...
MQTT_TOPIC = "channels/2885771/publish"
...
while True:
    try:
        ...
        # Print measurements
        print("Temperature: %4.1f°C, Pressure: %4.1f hPa, Light: %4.1f lux" % 
              (bmp280_temperature, bmp280_pressure, lux))
        
        # Create the JSON data structure with three fields
        MQTT_DATA = "field1=" + str(bmp280_temperature) + "&field2=" + str(bmp280_pressure) + \
                    "&field3=" + str(lux) + "&status=MQTTPUBLISH"
        print(MQTT_DATA)
